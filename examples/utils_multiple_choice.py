...
class ArcProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, type):
        ...
        for line in tqdm.tqdm(lines, desc="read arc data"):
            ...
            num_choices = len(data_raw["question"]["choices"])
            num_choices_counter[num_choices] = num_choices_counter.get(num_choices, 0) + 1
            ...
            question_context = clean_para(question_choices.get("para", ""))
            contexts = []
            endings = []
            for option in options:
                choice_context = clean_para(option.get("para", ""))
                if question_context and choice_context:
                    contexts.append(question_context + " " + choice_context)
                else:
                    contexts.append(question_context + choice_context)
        ...
        for num_choices, counter in num_choices_counter.items():
            logger.info("%d choices: %d", num_choices, counter)
