...
## todo: import launchpad qa models
...
class SearchState(object):
    """Tracks and recrods the state of a given search.
...
USAGE = """usage: python -m launchpadqa.question_search.model_search [options] [--help]
"""
DESCRIPTION = """Code for searching inside of decomposed questions"""

_CONFIG = OptionParser(usage=USAGE, description=DESCRIPTION)

## todo: add in pointers to models

_CONFIG.add_option("--generator_model_loc", dest="generator_model_loc", default='',
                   help="the location of the generator model [default='']")
_CONFIG.add_option("--qa_model", dest="qa_model", default='bert',
                   help="the type of QA model [default='bert']")

## dataset stuff

_CONFIG.add_option("--qa_dataset", dest="qa_dataset", default=None,
                   help="the background dataset to load with paragraphs (optional) [default='']")
_CONFIG.add_option("--dataset", dest="dataset", default='hotpotqa',
                   help="the target dataset type [choices='hotpotqa','qasc']")

## search parameters

## search strategies
_CONFIG.add_option("--search_strategy", dest="search_strategy", default='depth_first',
                   help="the location of the dataset [default='depth_first']")
_CONFIG.add_option("--top_k", dest="top_k", default=0.0, type=float,
                   help="The beam setting (usually use sampling) [default=0.0]")
_CONFIG.add_option("--normalize", dest="normalize", action='store_true', default=False,
                   help="Normalize probabilities when retrieving output from models [default=False]")
_CONFIG.add_option("--max_answers", dest="max_answers", default=1, type=int,
                   help="The maximum number of answers to consider during search [default=1]")

## general settings

_CONFIG.add_option("--logging", dest="logging", default='error', type=str,
                   help="The logging level [default='error']")

EXAMPLE = {
    "_id": "5a8e3ea95542995a26add48d",  # qid
    "qid": "5a8e3ea95542995a26add48d",  # qid
    "answer": "Greenwich Village, New York City",
    "question": "The director of the romantic comedy \"Big Stone Gap\" is based in what New York city?",
    "query": "sdsdsdsd",
    "query_0": "The director of the romantic comedy \"Big Stone Gap\" is based in what New York city?",
    "questions": [],
    "answers": [],
    "command_seq": ["gen", "qual", "gen"],
    "type": "bridge",
    "level": "hard"
}
...
def main(argv):
    ...
    """
    ## see example in `gpt_bert_controller.py`
    pass
