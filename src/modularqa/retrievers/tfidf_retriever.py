...
# LICENSE file in the root directory of https://github.com/facebookresearch/DrQA
# Slightly modified to better fit code base
...
from modularqa.retrievers import utils
from modularqa.retrievers.doc_db import DocDB
from modularqa.retrievers.retriever import Retriever
from modularqa.retrievers.simple_tokenizer import SimpleTokenizer

logger = logging.getLogger(__name__)


class TfidfDocRanker(Retriever):
    """Loads a pre-weighted inverted index of token/document terms.
    Scores new queries by taking sparse dot products.
    """

    def __init__(self, tfidf_file, db_file, num_paras=5):
        """
        Args:
