...
"""
Fine-tuning the library models for conditional text generation
"""
...
class DataCollatorForSeq2Seq:
    """
    Data collator used for seq2seq generation
    - collates batches of tensors, honoring their tokenizer's pad_token
    """

    tokenizer: PreTrainedTokenizer

    def __call__(self, input: List[torch.Tensor])  -> Dict[str, torch.Tensor]:
