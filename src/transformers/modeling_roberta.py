...
@add_start_docstrings(
    """Roberta Model with a multiple choice classification MLP head on top (a single-layer MLP and a
     softmax) e.g. for RocStories/SWAG/ARC tasks. """,
    ROBERTA_START_DOCSTRING,
)
class RobertaForMultipleChoiceMLP(BertPreTrainedModel):
    config_class = RobertaConfig
    pretrained_model_archive_map = ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP
    base_model_prefix = "roberta"
